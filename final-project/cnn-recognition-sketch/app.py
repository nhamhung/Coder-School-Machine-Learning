...
6:'aircraft', 7:'ice cream', 8:'laptop', 9:'mosquito', 10:'spider', 11:'sub marine', 12:'guitar', 13:'bed',
14:'angel', 15:'palm tree', 16:'helicopter'}
...
#         model = pickle.load(f)
model = tf.keras.models.load_model('model_cnn_more.h5')
